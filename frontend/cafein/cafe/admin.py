...
from cafe.models import Cafe, Cafe_image,Cafe_menu,Cafe_review,Cafe_comment,Cafe_sentiment,Cafe_keyword,Cafe_congestion,Cafe_favorites,Cafe_rank
...
admin.site.register(Cafe_favorites)
